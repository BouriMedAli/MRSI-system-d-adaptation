...
#One-hot encoding multiple pour la colonne "Compétences"

#Instanciation d'un objet de la classe MultiLabelBinarizer
mlb_skills = MultiLabelBinarizer() 
#transformer des labels multiples en une matrice binaire
...
#One-hot encoding multiple pour la colonne "Centres_d'Intérêt"
...
#Concaténation des colonnes traitées formant un nouveau dataframe
...
#-----------------------------------------------
# Étape 5 : Tester la recommandation
#-----------------------------------------------
...
def evaluate_recommendations_cosine(k=3):
    ...
    for i in range(len(df)):
        ...
        for j in range(len(df)):
            ...
            y_pred.append(1 if j in recommended_indices else 0)
            y_true.append(similarity)

    # Calculer la moyenne des scores de similarité
    avg_similarity = np.mean(y_true)
...
#Evaluation en utilisant cosine similarity
...
#-----------------------------------------------
# Étape x : Construire la matrice de collaborations
